...
<html lang="en">
    <head>
        ...
        <title>Sewa Alat campings</title>
    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
            <div class="container px-4">
                <a class="navbar-brand" href="/">Sanss Adventure</a>
...
<li class="list-group-item">
    ...
    <span class="float-end">72 Jam</span>
        ...
        <footer class="py-5 bg-dark">
            <div class="container px-4"><p class="m-0 text-center text-white">&copy; 2026 Sanss Adventure</p></div>
        </footer>
        <!-- Bootstrap core JS-->
